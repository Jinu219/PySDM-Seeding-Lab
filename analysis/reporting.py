...
def _quality_rows(summary: Dict[str, Any]) -> list[tuple[str, Any]]:
    ...
    suffixes = (
        ...
        "numerical_convergence_evidence.response_estimand_audit.available",
        "numerical_convergence_evidence.response_estimand_audit.n_common_random_seeds",
        "numerical_convergence_evidence.response_estimand_audit.scope",
        "spectrum_transition.status",
        "spectrum_transition.interpretation_status",
        "spectrum_transition.threshold_evidence_status",
        "spectrum_transition.checkpoint_cadence_status",
